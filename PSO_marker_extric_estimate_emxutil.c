...
{
  emxFree_real_T(&pStruct->pe);
  emxFree_real32_T(&pStruct->marker_location);
  emxFree_real_T(&pStruct->R_b2e);
}
...
{
  emxInit_real_T(&pStruct->pe, 2);
  emxInit_real32_T(&pStruct->marker_location, 2);
  emxInit_real_T(&pStruct->R_b2e, 3);
}
...
/*
 * File trailer for PSO_marker_extric_estimate_emxutil.c
 *
 * [EOF]
 */
